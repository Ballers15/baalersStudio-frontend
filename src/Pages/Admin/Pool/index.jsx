...
import {getAllRewardPot} from '../../../Services/Admin'
        ...
        try {
          ...
          if (getPotDetails.error) {
            ...
            setShowToaster(true);
              ...
              console.log(rewardPotDetailsArray)
          }
        } catch (error) {
        ...
        <React.Fragment>
            <div className="pool-listing">
                ...
                <div className="container">
                    ...
                    <tbody>
                        {rewardPotDetailsArray.map((pot, index) => {
                            return (
                                <tr key={pot?._id}>
                                <td>{index+1}</td>
                                <td>{pot?.potType}</td>
                                ...
                                <td>{pot?.assetDetails?.ticker}</td>
                                <td>{pot?.assetDetails?.contractAddress}</td>
                                <td>{pot?.assetDetails?.assetName}</td>
                                <td>
                                    <span>
